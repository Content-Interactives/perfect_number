...
const PerfectNumber = () => {
  ...
  const [stepSkipped, setStepSkipped] = useState({ step1: false, step2: false, step3: false });
        ...
        <div className="p-4 w-[500px]">
          ...
          <div className="bg-purple-50 p-4 rounded-lg border border-purple-200 w-[468px]">
                ...
                {numbers.map((_, idx) => (
                  <div
                    ...
                    className={`rounded-full transition-all duration-300 ${
                      ...
                      idx === currentIndex ? 
                        (divisorsChecked && isPerfectChecked ? 'w-3 h-3 bg-[#008545]' : 'w-2 h-2 bg-[#5750E3] mt-0.5') : 
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm mb-4 w-[436px]">
              <p className="font-medium text-sm select-none">Analyze the following number:</p>
              <p className="mt-2 font-semibold text-2xl text-center select-none">{numbers[currentIndex]}</p>
            </div>

            <div className="space-y-4 w-[436px]">
              <div>
                <p className="text-purple-900 mb-2 select-none">1. What are the proper divisors?</p>
                {!divisorsChecked ? (
                  <div className="flex items-center gap-4 mt-3 mb-1">
                    <Input
                      ...
                      className={`w-[200px] bg-white ${
                        hasError.divisors ? 'border-yellow-500' : 'border-gray-300'
                      }`}
                    ...
                    <div className="glow-button simple-glow">
                      <div className="flex gap-3">
                        <Button 
                          ...
                          className="bg-[#00783E] hover:bg-[#006633] text-white text-sm px-4 py-2 rounded select-none"
                        >
                          Check
                        </Button>
                        <Button
                          ...
                          className="bg-gray-400 hover:bg-gray-500 text-white text-sm px-4 py-2 rounded select-none"
                        >
                          Skip
                        </Button>
                      </div>
              ...
              {divisorsChecked && (
                <div>
                  <p className="text-purple-900 mb-2 select-none">2. Is it a perfect number?</p>
                  {!isPerfectChecked ? (
                    <div className="flex items-center gap-4 mt-3 mb-1">
                      <Input
                        type="text"
                        ...
                        className={`w-[120px] bg-white ${
                          hasError.perfect ? 'border-yellow-500' : 'border-gray-300'
                        }`}
